...
Level 2 - This file name starts with dashes and has spaces, so to solve the spaces problem i used ' ' again but when that didnt work i tried by giving linux the absolute path, 
